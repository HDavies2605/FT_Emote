...
AFT_EmoteCharacter::AFT_EmoteCharacter()
{
...
void AFT_EmoteCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void AFT_EmoteCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AFT_EmoteCharacter::Look);
	}
	else
	{
...
void AFT_EmoteCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AFT_EmoteCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
